namespace DataStore.Interfaces
{
    ...
    public interface IDataStoreReadOnly
    {
        ...
        Task<T> ReadActiveById<T>(string longId, Action<ReadClientSideOptions> setOptions = null, string methodName = null) where T : class, IAggregate, new();
        ...
        Task<T> ReadById<T>(string longId, Action<ReadClientSideOptions> setOptions = null, string methodName = null) where T : class, IAggregate, new();
    }
}