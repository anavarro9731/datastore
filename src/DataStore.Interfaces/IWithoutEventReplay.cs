namespace DataStore.Interfaces
{
    ...
    public interface IWithoutEventReplay
    {
        ...
        Task<IEnumerable<T>> Read<T, O>(Action<O> setOptions) where T : class, IAggregate, new() where O : class, IWithoutReplayOptionsLibrarySide<T>, new();
        ...
        Task<IEnumerable<T>> ReadActive<T, O>(Action<O> setOptions) where T : class, IAggregate, new() where O : class, IWithoutReplayOptionsLibrarySide<T>, new();
