namespace DataStore.Interfaces
{
    ...
    public interface IWithoutEventReplay
    {
        ...
        Task<int> Count<T>(Expression<Func<T, bool>> predicate = null, Action<WithoutReplayOptionsClientSide<T>> setOptions = null) where T : class, IAggregate, new();

        Task<int> CountActive<T>(Expression<Func<T, bool>> predicate = null, Action<WithoutReplayOptionsClientSide<T>> setOptions = null) where T : class, IAggregate, new();
        
        Task<int> Count<T, O>(Expression<Func<T, bool>> predicate = null, Action<O> setOptions = null) where T : class, IAggregate, new() where O : WithoutReplayOptionsClientSideBase<T>, new();

        Task<int> CountActive<T, O>(Expression<Func<T, bool>> predicate = null, Action<O> setOptions = null) where T : class, IAggregate, new() where O : WithoutReplayOptionsClientSideBase<T>, new();
        ...
        Task<T> ReadById<T>(Guid modelId, Action<WithoutReplayOptionsClientSideIdOnly<T>> setOptions = null) where T : class, IAggregate, new();
        ...
        Task<T> ReadActiveById<T>(Guid modelId, Action<WithoutReplayOptionsClientSideIdOnly<T>> setOptions = null) where T : class, IAggregate, new();
