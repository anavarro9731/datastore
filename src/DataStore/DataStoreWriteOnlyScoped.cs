namespace DataStore
{
    ...
    public class DataStoreWriteOnly<T> : IDataStoreWriteOnly where T : class, IAggregate, new()
    {
        ...
        public Task<T1> Create<T1>(T1 model, Action<ClientSideCreateOptions> setOptions = null, string methodName = null)
        ...
        public Task<T1> Delete<T1>(T1 instance, Action<ClientSideDeleteOptions> setOptions = null, string methodName = null)
            where T1 : class, IAggregate, new() =>
            this.dataStore.Delete(instance, setOptions, methodName);
        ...
        public Task<T1> DeleteById<T1>(Guid id, Action<ClientSideDeleteOptions> setOptions = null, string methodName = null)
            where T1 : class, IAggregate, new() =>
        ...
        public Task<T1> Update<T1>(T1 src, Action<ClientSideUpdateOptions> setOptions = null, string methodName = null)
            where T1 : class, IAggregate, new() =>
            this.dataStore.Update(src, setOptions, methodName);
