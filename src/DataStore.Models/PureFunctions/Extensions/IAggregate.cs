namespace DataStore.Models.PureFunctions.Extensions
{
    ...
    {
        internal static void ForcefullySetMandatoryPropertyValues<T>(this T newObject, bool readOnly) where T : class, IAggregate, new()
        {
            newObject.Schema =
            ...
            newObject.PartitionKey = newObject.id.ToString(); /*
