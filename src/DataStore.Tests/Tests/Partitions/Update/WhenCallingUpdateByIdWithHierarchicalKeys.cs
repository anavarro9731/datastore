namespace DataStore.Tests.Tests.Partitions.Update
{
    ...
    public class WhenCallingUpdateByIdWithHierarchicalKeys
    {
        [Fact]
        private async void AndAttributeWithTypeIdKeyItShouldUpdateIt()
        {
            ...
            var testHarness = TestHarness.Create(
                nameof(WhenCallingUpdateByIdWithHierarchicalKeys) + nameof(AndAttributeWithTypeIdKeyItShouldUpdateIt),
        ...
        private async void AndAttributeWithTypeTenantIdKeyItShouldUpdateIt()
        {
            // Given
            var testHarness = TestHarness.Create(
                nameof(WhenCallingUpdateByIdWithHierarchicalKeys) + nameof(AndAttributeWithTypeTenantIdKeyItShouldUpdateIt),
                useHierarchicalPartitionKey: true);
        ...
        private async void AndAttributeWithTypeTimePeriodKeyItShouldUpdateIt()
        {
            // Given
            var testHarness = TestHarness.Create(
                nameof(WhenCallingUpdateByIdWithHierarchicalKeys) + nameof(AndAttributeWithTypeTimePeriodKeyItShouldUpdateIt),
                useHierarchicalPartitionKey: true);
        ...
        private async void AndAttributeWithTypeTenantTimePeriodKeyItShouldUpdateIt()
        {
            // Given
            var testHarness = TestHarness.Create(
                nameof(WhenCallingUpdateByIdWithHierarchicalKeys) + nameof(AndAttributeWithTypeTenantTimePeriodKeyItShouldUpdateIt),
                useHierarchicalPartitionKey: true);
