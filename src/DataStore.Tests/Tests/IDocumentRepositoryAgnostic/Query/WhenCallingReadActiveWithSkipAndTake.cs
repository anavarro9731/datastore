namespace DataStore.Tests.Tests.IDocumentRepositoryAgnostic.Query
{
    ...
    public class WhenCallingReadActiveWithSkipAndTake
    {
        ...
        {
            // Given
            this.testHarness = TestHarnessFunctions.GetTestHarness(nameof(WhenCallingReadActiveWithSkipAndTake));
            ...
            // When
            this.carsFromDatabase = this.testHarness.DataStore.ReadActive<Car>(car => car.Make == "Volvo", () => InMemoryDocumentRepository.QueryOptions.Create(1, 2))
                                        .Result;
        }
