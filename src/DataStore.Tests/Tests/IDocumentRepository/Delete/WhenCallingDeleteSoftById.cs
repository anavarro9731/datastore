namespace DataStore.Tests.Tests.IDocumentRepository.Delete
{
    ...
    public class WhenCallingDeleteSoftById
    {
        ...
        {
            await Setup();
            Assert.NotNull(this.testHarness.DataStore.ExecutedOperations.SingleOrDefault(e => e is UpdateOperation<Car> && e.MethodCalled == nameof(DataStore.DeleteSoftById)));
