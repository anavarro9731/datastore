...
namespace DataStore.Tests.Tests
{
    ...
    {
        [Fact]
        public async void Integration_WhenDocumentsAreCreatedWithIdAsThePartitionKey_ItShouldPutThemAllInSeparatePartitions() //up to the max no. of partitions (e.g. 25)
        {
            //Given
            var docDbCollectionSettings = DocDbCollectionSettings.Create(nameof(Integration_WhenDocumentsAreCreatedWithIdAsThePartitionKey_ItShouldPutThemAllInSeparatePartitions),
        ...
        [Fact]
        public async void Integration_WhenDocumentsAreCreatedWithClassNameAsThePartitionKey_ItShouldPutThemAllInTheSamePartition()
        {
            //Given
            var docDbCollectionSettings = DocDbCollectionSettings.Create(nameof(Integration_WhenDocumentsAreCreatedWithClassNameAsThePartitionKey_ItShouldPutThemAllInTheSamePartition),
